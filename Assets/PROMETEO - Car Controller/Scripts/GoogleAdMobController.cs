...
public class GoogleAdMobController : MonoBehaviour
{
    ...
    public string bannerId, interstitialId, bannerIOS, interstitialIOS, IOSAppID, AppOpenId;
    ...
    /*  private void Awake()
      {
          if (!FindObjectOfType<GoogleAdMobController>())
          {
...
/*    public void CustomLoadRewardedAd()
    {
  ...
  /*  public void CustomShowRewardedAd()
    {
